...
public class TumorMappingTest {
  ...
  @BeforeEach void setUp() {
    mapping = new TumorMapping(new FhirPathR4(FhirContext.forR4()));
  }

  @ParameterizedTest
  @CsvFileSource(resources = "/tumorMappings.csv", numLinesToSkip = 1)
  void map_TumorConditionCSVFile(
      String FHIR_ICD10, String FHIR_ICD_O_3, String FHIR_ADT_Site, String DKTK_ICD10, String DKTK_ICD_O_3, String DKTK_site
  ) {
    var condition = new Condition();
    condition.getBodySiteFirstRep().getCodingFirstRep().setSystem(ICD_O_3).setCode(FHIR_ICD10).setVersion(FHIR_ICD_O_3);;
    var coding = new Coding().setSystem("urn:oid:2.16.840.1.113883.2.6.60.7.1.1").setCode(FHIR_ADT_Site);
